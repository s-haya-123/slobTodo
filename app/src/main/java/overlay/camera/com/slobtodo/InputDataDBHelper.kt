...
class InputDataDBHelper(var mContext: Context?,var version:Int) : SQLiteOpenHelper(mContext, "INPUT_DATA", null, version) {
    companion object {
        ...
        val CREATE_LINE_DATA = "create table line_data ( _id integer primary key autoincrement, ischecked boolean not null,todo text not null,inputDataId integer not null, isdeleted text,_index inteder not null, created_time text not null, updated_time text not null );"
